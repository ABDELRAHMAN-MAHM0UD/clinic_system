    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <a href="{{ route('admin.doctors') }}" 
               class="block bg-white border border-gray-200 rounded-xl shadow hover:shadow-lg transition p-4 text-center h-48">
                <div class="flex flex-col items-center justify-center h-full">
                    ...
                    <p class="text-gray-500 text-sm">Manage doctors info</p>
                </div>
            </a>
            ...
            <a href="{{ route('admin.patients') }}" 
               class="block bg-white border border-gray-200 rounded-xl shadow hover:shadow-lg transition p-4 text-center h-48">
                <div class="flex flex-col items-center justify-center h-full">
                    ...
                    <p class="text-gray-500 text-sm">Manage patient records</p>
                </div>
            </a>
            ...
            <a href="{{ route('admin.invoices') }}" 
               class="block bg-white border border-gray-200 rounded-xl shadow hover:shadow-lg transition p-4 text-center h-48">
                <div class="flex flex-col items-center justify-center h-full">
                    ...
                    <p class="text-gray-500 text-sm">View and manage invoices</p>
                </div>
            </a>
            ...
            <a href="{{ route('admin.appointments') }}" 
               class="block bg-white border border-gray-200 rounded-xl shadow hover:shadow-lg transition p-4 text-center h-48">
                <div class="flex flex-col items-center justify-center h-full">
                    ...
                    <p class="text-gray-500 text-sm">Schedule and view appointments</p>
                </div>
            </a>
